          ...
          <div className="overflow-y-auto gap-2 m-2">
            {files.map((file) => (
              <Link
                ...
                className="animate-in fade-in-0 duration-200 py-2 px-3 text-gray-500 hover:text-blue-500 hover:bg-gray-100 rounded grid grid-cols-2 gap-4 ph-no-capture"
              >

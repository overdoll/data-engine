...
import { CheckCircleSolid, CircleDottedLine, CircleHalfSolid } from "@/icons/index"
...
interface ProgressTabsTriggerProps
  extends Omit<React.ComponentPropsWithoutRef<typeof ProgressTabsPrimitives.Trigger>, "asChild"> {
  status?: ProgressStatus
}
